...
<!-- templates for adding portions of the header to the HTML page -->
  ...
  <!-- add styles and scripts from IEDA dataset landing pages to get map on page. -->
...
<!-- added styles -->
  <link rel="stylesheet" href="datadoi.css"/>
...
<!-- 2018-05-01 added scripts for displaying result on map -->
  ...
  AIzaSyDvMq13TckYWDv9vyA_NLaF_pID0pwZoww  generated by smrTucson@gmail.com 2018-05-02 
  AIzaSyATYahozDIlFIM1mO7o66AocXi72mkPT18  key in original script 
  AIzaSyD0APJ8aoq4j1S118KECSw92fGgs9RNAaU api key new
  remove sensor parameter from scriopt call, it is deprecated -->
  ...
  <script src="http://maps.googleapis.com/maps/api/js?key=AIzaSyD0APJ8aoq4j1S118KECSw92fGgs9RNAaU&amp;libraries=drawing" type="text/javascript"></script>
  <xsl:text>&#10;</xsl:text>                
