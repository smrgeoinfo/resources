...
<!-- this is used for the Data Centre keyword type -->
    <xsl:variable name="datacentre" select="string('US Antarctic Program Data Center (USAP-DC)')"/>
        ...
        <gmd:contact>
            <gmd:CI_ResponsibleParty>
                <gmd:organisationName>
                    <gco:CharacterString>US Antarctic Program Data Center (USAP-DC) | Interdisciplinary Earth Data Alliance | Columbia Univeristy</gco:CharacterString>
                </gmd:organisationName>
                <gmd:contactInfo>
                    <gmd:CI_Contact>
                        <gmd:address>
...
<!-- SMR20171014 set up key for grouping dataCite Subject element with the same subject scheme -->
 ...
 from the USAP-DC database; The transform was
                ...
                <gmd:descriptiveKeywords>
                    <gmd:MD_Keywords>
                        ...
                        <xsl:choose>
                            ...
                            <xsl:when
                                test="translate($theScheme, $uppercase, $smallcase) = 'topic' ">
                                <gmd:type>
                                    <gmd:MD_KeywordTypeCode
                                        codeList="http://www.ngdc.noaa.gov/metadata/published/xsd/schema/resources/Codelist/gmxCodelists.xml#MD_KeywordTypeCode"
                            ...
                            <xsl:when
                                test="translate($theScheme, $uppercase, $smallcase) = 'feature of interest' ">
                                <gmd:type>
                                    <gmd:MD_KeywordTypeCode
                                        codeList="http://www.ngdc.noaa.gov/metadata/published/xsd/schema/resources/Codelist/gmxCodelists.xml#MD_KeywordTypeCode"
                            ...
                            <xsl:when
                                test="translate($theScheme, $uppercase, $smallcase) = 'data type' ">
                                <gmd:type>
                                    <gmd:MD_KeywordTypeCode
                                        codeList="http://www.ngdc.noaa.gov/metadata/published/xsd/schema/resources/Codelist/gmxCodelists.xml#MD_KeywordTypeCode"
