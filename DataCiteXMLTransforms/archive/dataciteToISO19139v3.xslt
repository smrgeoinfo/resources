...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
        ...
        <gmd:contact>
            <gmd:CI_ResponsibleParty>
                <gmd:organisationName>
                    <gco:CharacterString>Interdisciplinary Earth Data Alliance | Lamont Doherty
                        Earth Observatory | Columbia Univeristy</gco:CharacterString>
                </gmd:organisationName>
                <gmd:contactInfo>
                    <gmd:CI_Contact>
                        <gmd:address>
    ...
    <xsl:variable name="metaMaintenanceNote"
        select="
            string('This metadata record was generated by an xslt transformation from DataCite metadata records exported
 from the EarthChem Library database; The originator of the DataCite record is cited in the metadataContact field of this record. The transform was
                ...
                <gmd:MD_Distribution>
                    <gmd:transferOptions>
                        <gmd:MD_DigitalTransferOptions>
                            ...
                            <xsl:for-each
                                select="//*[local-name() = 'alternateIdentifier' and (contains(@alternateIdentifierType,'landing') or 
                                contains(@alternateIdentifierType, 'Landing'))]">
                                <xsl:if test=". != ''">
                                    <gmd:onLine>
                                        <gmd:CI_OnlineResource>
                                            <gmd:linkage>
        ...
        <xsl:for-each select="//*[local-name() = 'subject' and @subjectScheme != '']">
            <gmd:descriptiveKeywords>
                <gmd:MD_Keywords>
                    ...
                    <xsl:choose>
                        <xsl:when
                            test="@subjectScheme = 'place' or contains(@subjectScheme, 'geograph') or contains(@subjectScheme, 'location')">
                            <gmd:type>
                                <gmd:MD_KeywordTypeCode
                                    codeList="http://www.isotc211.org/2005/resources/Codelist/gmxCodelists.xml#MD_KeywordTypeCode"
                                    codeListValue="place" codeSpace="ISOTC211/19115"
                                    >place</gmd:MD_KeywordTypeCode>
                            </gmd:type>
                        </xsl:when>
                        <xsl:when
                            test="@subjectScheme = 'datatype' or contains(@subjectScheme, 'theme')">
                            <gmd:type>
                                <gmd:MD_KeywordTypeCode
                                    codeList="http://www.isotc211.org/2005/resources/Codelist/gmxCodelists.xml#MD_KeywordTypeCode"
