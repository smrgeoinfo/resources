...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:variable name="metadataMaintenanceNote"
        select="'This metadata was harvested via csw bulk download of 1212 record on 20170728 is ISO19139 xml format, 
        and processed by IEDA SplitMD_Metadata.xsl to transform to conform with IEDA metadata conventions. 
        Vertical extent encoding moved from geographic identifier to verticalExtent elements; extra > None in 
