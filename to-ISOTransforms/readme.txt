...
TransformJob will recognize DataCite XML, Dublin Core XML (OAI or rdf flavors), EML (tested with v2.1.1) XML, and CSDGM (FGDC) XML, and writes to a directory tree constructed to reflect the directory tree of the web location it was pointed at. It is designed to scrape metadat from a web accessible folder and write ISO 19139 xml for another WAF to be harvested by an ISO metadata aggregator.
